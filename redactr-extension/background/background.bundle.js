...
// node_modules/@firebase/auth/dist/web-extension-esm2017/register-8de454ae.js
...
var GOOGLE_OAUTH_CLIENT_ID = "116258256150-bk6aec5oadquj8hioc1qac1092nbar50.apps.googleusercontent.com";
...
var DEFAULT_STATE = {
  ...
  tier2Allowed: false,
  // entitlement: only true on the Enterprise plan (see getEntitlement)
  plan: null,
  role: null,
  ...
  customKeywords: [],
  // Enterprise-only, admin-managed (see getEntitlement)
  customEntities: [],
  // Enterprise-only GLiNER labels (see getEntitlement + addCustomEntity)
  trialDaysLeft: 0,
  trialExpired: false,
  // Enterprise file scanning
  fileInterceptEnabled: false,
  fileInterceptAllowed: false,
  // true when plan === "enterprise"
  filesBlocked: 0
};
var OFFSCREEN_PATH = "offscreen/offscreen.html";
...
chrome.runtime.onMessage.addListener((message, sender, sendResponse) => {
  ...
  if (message?.type === "SIGN_IN") {
    signInWithGoogle().then((user) => sendResponse({ ok: true, user: { email: user.email, displayName: user.displayName } })).catch((error) => sendResponse({ ok: false, error: String(error) }));
    return true;
  }
...
@firebase/auth/dist/web-extension-esm2017/register-8de454ae.js:
  (**
   * @license
   * Copyright 2020 Google LLC
   *
