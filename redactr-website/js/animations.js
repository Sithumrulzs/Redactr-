...
document.addEventListener('DOMContentLoaded', () => {
  ...
  if (demoSection) {
    ...
    function addFindingChip(label) {
      ...
      chip.innerHTML = `<span>${label}</span><span class="chip-check warn"><svg class="icon-inline" viewBox="0 0 24 24" width="12" height="12" fill="none" stroke="currentColor" stroke-width="2.5"><path d="M12 9v4M12 17h.01M10.29 3.86 1.82 18a2 2 0 0 0 1.71 3h16.94a2 2 0 0 0 1.71-3L13.71 3.86a2 2 0 0 0-3.42 0Z"/></svg></span>`;
